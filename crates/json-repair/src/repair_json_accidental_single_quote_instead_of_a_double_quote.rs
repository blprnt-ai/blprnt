...
pub fn repair_json_accidental_single_quote_instead_of_double_quote(input: &str) -> Result<String, JsonRepairError> {
...
mod repair_accidental_single_quote_tests {
  ...
  fn test_repair_single_quote_instead_of_double_quote() -> Result<(), JsonRepairError> {
    ...
    let output_json: Value =
      serde_json::from_str(&output).map_err(|inner| JsonRepairError::SerdeParseError { inner })?;
