...
#[derive(Clone, Debug, Eq, PartialEq, serde::Serialize, serde::Deserialize, SurrealValue)]
...
#[derive(Clone, Debug, Eq, PartialEq, serde::Serialize, serde::Deserialize, SurrealEnumValue)]
