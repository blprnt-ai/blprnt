...
mod tests {
  ...
  use crate::grid::storage::MAX_CACHE_SIZE;
  ...
  fn initialize() {
    ...
    let mut expected_inner =
      vec![filled_row('0'), filled_row('1'), filled_row('2'), filled_row('3'), filled_row('4'), filled_row('5')];
    ...
    let expected_storage =
      Storage { inner: expected_inner, zero: 0, visible_lines: 0, len: 9 };
