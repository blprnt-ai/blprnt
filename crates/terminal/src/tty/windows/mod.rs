...
use blocking::UnblockedReader;
use blocking::UnblockedWriter;
...
mod test {
  ...
  use crate::tty::windows::push_escaped_arg;
  ...
  fn test_cmdline() {
    let mut options = Options {
      shell:             Some(Shell { program: "echo".to_string(), args: vec!["hello world".to_string()] }),
