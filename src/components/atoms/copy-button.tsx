...
import { ButtonPrimitive, type ButtonPrimitiveProps } from '@/components/atoms/primitives/button'
import { useControlledState } from '@/hooks/use-controlled-state'
import { cn } from '@/lib/utils/cn'
import { basicToast as toast } from './toaster'
  ...
  const handleCopy = React.useCallback(
    async (e: React.MouseEvent<HTMLButtonElement>) => {
      try {
        ...
        toast.info({ dismissible: false, duration: 3000, position: 'bottom-right', title: 'Copied to clipboard' })
