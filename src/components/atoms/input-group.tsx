  ...
  return (
    <div
      ...
      className={cn(
        ...
        'h-9 min-w-0 has-[>textarea]:h-auto px-2 py-4.5',
        ...
        '[&_input]:bg-none! [&_input]:backdrop-blur-none!',
...
export const InputGroupSwitch = ({ className, ...props }: React.ComponentProps<typeof Switch>) => {
  return <Switch className={cn(className)} data-slot="input-group-control" {...props} />
}
