---
name: brainstorming
description: "Use this only for pre-implementation scoping conversations: exploring ideas, clarifying requirements, surfacing constraints, and comparing approaches. Do not use it during coding, editing, execution, or for producing implementation plans, specs, or tests."
---
