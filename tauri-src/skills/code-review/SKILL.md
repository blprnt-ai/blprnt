...
### Security Checklist
Reference: [code-review/checklists/security.md](code-review/checklists/security.md)
...
Reference: [code-review/checklists/performance.md](code-review/checklists/performance.md)
- [ ] No N+1 queries
- [ ] Appropriate caching
...
Reference: [code-review/checklists/maintainability.md](code-review/checklists/maintainability.md)
- [ ] Code is readable
...
Reference: [code-review/checklists/accessibility.md](code-review/checklists/accessibility.md)
- [ ] Semantic HTML
- [ ] ARIA labels
- [ ] Keyboard navigation
- [ ] Color contrast
