 ...
 */
function getClassNames(variant: string, size: string, disabled: boolean, className?: string): string {
  const classes = ['component-name', `component-name--${variant}`, `component-name--${size}`]
...
export function ComponentName({
  ...
  return (
    ...
    >
      ...
      {/* Content section */}
      {children && <div className="component-name__content">{children}</div>}

      {/* State indicator (example) */}
      {internalState && <div className="component-name__indicator">Active</div>}
    </div>
  )
}
