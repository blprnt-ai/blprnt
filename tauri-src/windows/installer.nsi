...
; 7. Optional Bun page
Page custom BunInstallPage BunInstallPageLeave
...
Function BunInstallPageLeave
 ${IfThen} $BunInstallCheckbox == "" ${|} Return ${|}
...
Function un.ConfirmShow ; Add add a `Delete app data` check box
 ...
 IntOp $5 125 * $2
 IntOp $5 $5 / 96
 System::Call 'user32::CreateWindowEx(i r3, w "${__NSD_CheckBox_CLASS}", w "Remove Bun installed by ${PRODUCTNAME}", i ${__NSD_CheckBox_STYLE}, i r4, i r5, i r6, i r7, p r1, i0, i0, i0) i .s'
 Pop $BunUninstallCheckbox
 SendMessage $BunUninstallCheckbox ${WM_SETFONT} $1 1
 IfFileExists "${BLPRNT_BUN_DIR}\bun.exe" 0 bun_uninstall_checkbox_clear
 SendMessage $BunUninstallCheckbox ${BM_SETCHECK} ${BST_CHECKED} 0
 Goto bun_uninstall_checkbox_done
 bun_uninstall_checkbox_clear:
 SendMessage $BunUninstallCheckbox ${BM_SETCHECK} ${BST_UNCHECKED} 0
 bun_uninstall_checkbox_done:
FunctionEnd
!define MUI_PAGE_CUSTOMFUNCTION_LEAVE un.ConfirmLeave
Function un.ConfirmLeave
 SendMessage $DeleteAppDataCheckbox ${BM_GETCHECK} 0 0 $DeleteAppDataCheckboxState
 SendMessage $BunUninstallCheckbox ${BM_GETCHECK} 0 0 $BunUninstallCheckboxState
FunctionEnd
...
Section Uninstall
 ...
 ${If} $BunUninstallCheckboxState = 1
 ${AndIf} $UpdateMode <> 1
   Push "${BLPRNT_BUN_DIR}"
